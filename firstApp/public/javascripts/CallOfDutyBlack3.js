$(document).ready(
    function() {
        ...
        function getComments() {
            $.get("/get_CallOfDutyBlack3_Comments", function (data) {
                var posts = "";
        ...
        $("#postForm").submit(function (event) {
            ...
            $.post("/add_CallOfDutyBlack3_Comments", {
        ...
        $("#feedPosts").click(function (event) {
            ...
            if (event.target.value == 0) {
                $.ajax({
                    url: '/remove_CallOfDutyBlack3_Comments/' + event.target.name,
                    type: 'DELETE',
        ...
        $("#feedPosts").click(function (event) {
            ...
            if (event.target.value == 1) {
              ...
              if(updatedComment == "" || updatedComment == null) {
                ...
                $.ajax({
                    url: '/update_CallOfDutyBlack3_Comment/' + event.target.name,
                    type: 'PUT',
